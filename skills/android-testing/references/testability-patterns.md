...
- **Force Immediate Sync**: Instead of waiting for `WorkManager` or
  ...
  with the companion app or backend. This guarantees your automated tests don't
  flake due to background execution delays.
...
- **Instrumentation**: Add a debug overlay or log that explicitly prints the
  *source* of the connectivity state (e.g., "Source: Local TelephonyManager" vs
