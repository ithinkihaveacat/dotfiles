function fish_prompt --description 'Write out the prompt'
  ...
  if not set -q __fish_prompt_color_begin
    set -g __fish_prompt_color_begin (set_color -i -o)
  end
  ...
  if not set -q __fish_prompt_color_hostname
    set -g __fish_prompt_color_hostname (set_color -u $fish_color_hostname)
  end
  ...
  if not set -q __fish_prompt_color_sigil
    set -g __fish_prompt_color_sigil (set_color $fish_color_sigil)
  end
  ...
  echo -n -s "$__fish_prompt_color_begin" "$__fish_prompt_color_hostname" "$__fish_prompt_hostname" "$__fish_prompt_color_normal" ' ' "$__fish_prompt_color_cwd" (prompt_pwd) "$__fish_prompt_color_git" (__fish_git_prompt "#%s") "$__fish_prompt_color_sigil" ' $ ' "$__fish_prompt_color_normal"
