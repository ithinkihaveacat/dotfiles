...
complete -c hook -n __fish_use_subcommand -a list -d 'List the hooks installed in this repository'
complete -c hook -n __fish_use_subcommand -a ls -d 'List the hooks installed in this repository'
