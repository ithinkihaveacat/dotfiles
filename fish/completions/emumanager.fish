...
complete -c emumanager -f -n __fish_emumanager_needs_command -a list -d 'List local resources (avds, packages)'
...
complete -c emumanager -f -n '__fish_emumanager_using_command list; and not __fish_seen_subcommand_from avd avds package packages' -a 'avds packages' -d 'Resource type'
...
complete -c emumanager -f -n '__fish_emumanager_using_command catalog; and not __fish_seen_subcommand_from packages' -a packages -d 'Resource type'
complete -c emumanager -f -n '__fish_emumanager_using_command update; and not __fish_seen_subcommand_from packages' -a packages -d 'Resource type'
...
complete -c emumanager -f -n '__fish_seen_subcommand_from list; and __fish_seen_subcommand_from avd avds' -l names-only -d 'Output only AVD names without decoration'
complete -c emumanager -f -n '__fish_seen_subcommand_from list; and __fish_seen_subcommand_from avd avds' -l running-only -d 'Output only running AVD names'
complete -c emumanager -f -n '__fish_seen_subcommand_from list; and __fish_seen_subcommand_from avd avds' -l stopped-only -d 'Output only stopped AVD names'

complete -c emumanager -f -n '__fish_seen_subcommand_from list; and __fish_seen_subcommand_from package packages' -l outdated -d 'List local packages that have remote updates available'
