...
complete -c jetpack -n '__fish_seen_subcommand_from version' -a 'ALPHA BETA RC STABLE LATEST SNAPSHOT' -d 'Version type'
...
complete -c jetpack -n '__fish_seen_subcommand_from source' -a 'ALPHA BETA RC STABLE LATEST SNAPSHOT' -d 'Version type'
...
complete -c jetpack -n '__fish_seen_subcommand_from inspect' -a 'ALPHA BETA RC STABLE LATEST SNAPSHOT' -d 'Version type'
