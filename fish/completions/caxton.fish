...
complete -c caxton -l search -d "Enable Google Search grounding for external context"
complete -c caxton -l code -d "Enable Python code execution in cloud sandbox"
