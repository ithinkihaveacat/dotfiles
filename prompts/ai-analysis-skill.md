...
Ensure these executable files exist in `scripts/` as the canonical
implementations:

- `scripts/screenshot-describe`
- `scripts/screenshot-compare`
...
These scripts are self-contained. No additional script files are required for
this skill.
